...
export default function Home(){return <main className="min-h-screen grid-bg overflow-hidden">
 ...
 <section className="max-w-7xl mx-auto px-6 py-16 grid lg:grid-cols-2 gap-16 items-center">
  <div><span className="inline-flex px-4 py-2 rounded-full bg-lime-300/10 text-lime-300 text-sm">منصة ولاء متعددة البراندات</span><h1 className="text-5xl md:text-7xl font-black leading-[1.08] mt-6">خلّ عملاءك<br/>يرجعون أكثر.</h1><p className="text-lg text-white/55 mt-6 max-w-xl leading-8">بطاقات ولاء ذكية، QR سريع للموظفين، مكافآت مرنة، وتصميم Apple Wallet قابل للتعديل من لوحة واحدة.</p><div className="flex gap-3 mt-8"><Link href="/admin" className="bg-lime-300 text-black px-6 py-4 rounded-2xl font-bold flex items-center gap-2">فتح المنصة <ArrowLeft size={18}/></Link><Link href="/join" className="glass px-6 py-4 rounded-2xl font-bold">تجربة العميل</Link></div>
