    ...
    async with app.router.lifespan_context(app):
        async with httpx.AsyncClient(transport=httpx.ASGITransport(app=app), base_url="http://test") as client:
            ...
            print(json.dumps({
                ...
                "version": "6.0.0", "security_checks": ["tenant_isolation", "central_wallet_forbidden", "password_preserved", "cross_branch_rejected", "employee_branch_scope", "employee_customer_privacy", "permission_revocation", "password_session_revocation", "campaign_audience_isolation"],
            }, ensure_ascii=False))
